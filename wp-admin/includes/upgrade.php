...
function wp_install_maybe_enable_pretty_permalinks() {
	...
	$permalink_structures = array(
		...
		'/front-page.php/%year%/%monthnum%/%day%/%postname%/'
	);
...
function make_site_theme_from_oldschool($theme_name, $template) {
	...
	if (! file_exists("$home_path/front-page.php"))
		return false;
	 ...
	 */
	$files = array('front-page.php' => 'front-page.php', 'wp-layout.css' => 'style.css', 'wp-comments.php' => 'comments.php', 'wp-comments-popup.php' => 'comments-popup.php');

	foreach ($files as $oldfile => $newfile) {
		if ($oldfile == 'front-page.php')
			$oldpath = $home_path;
		else
			$oldpath = ABSPATH;
		...
		if ($oldfile == 'front-page.php') {
			...
			if (strpos($index, 'WP_USE_THEMES') !== false) {
				if (! @copy(WP_CONTENT_DIR . '/themes/' . WP_DEFAULT_THEME . '/front-page.php', "$site_dir/$newfile"))
					return false;
...
function make_site_theme_from_default($theme_name, $template) {
	...
	//$files = array('front-page.php', 'comments.php', 'comments-popup.php', 'footer.php', 'header.php', 'sidebar.php', 'style.css');
