...
$menu[2] = array( __('Dashboard'), 'read', 'front-page.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard' );

$submenu[ 'front-page.php' ][0] = array( __('Home'), 'read', 'front-page.php' );

if ( is_multisite() ) {
	$submenu[ 'front-page.php' ][5] = array( __('My Sites'), 'read', 'my-sites.php' );
}
