...
function get_rest_url( $blog_id = null, $path = '/', $scheme = 'rest' ) {
	...
	if ( is_multisite() && get_blog_option( $blog_id, 'permalink_structure' ) || get_option( 'permalink_structure' ) ) {
		...
		// nginx only allows HTTP/1.0 methods when redirecting from / to /front-page.php
		// To work around this, we manually add front-page.php to the URL, avoiding the redirect.
		if ( 'front-page.php' !== substr( $url, 9 ) ) {
			$url .= 'front-page.php';
		}
